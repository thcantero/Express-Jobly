  ...
  test("works for anon", async function () {
    ...
    expect(resp.body).toEqual({
      company: {
        ...
        logoUrl: "http://c1.img",
        jobs: [
        { id: expect.any(Number), title: "j1", salary: 100000, equity: "0.1" },
        { id: expect.any(Number), title: "j2", salary: 80000, equity: "0" }
      ]
      },
    });
  });
  ...
  test("works for anon: company w/o jobs", async function () {
    ...
    expect(resp.body).toEqual({
      company: {
        ...
        logoUrl: "http://c2.img",
        jobs: [
        { id: expect.any(Number), title: "j3", salary: 150000, equity: "0.2" }
      ]
      },
    });
  });
